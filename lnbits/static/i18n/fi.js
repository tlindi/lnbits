window.localisation.fi = {
  ...
  lnbits_description:
    'Kevyt ja helppokäyttöinen LNbits voi käyttää rahoituslähteinään useita Lightning-palveluita ja jopa toista LNbits-palvelua! Voit käyttää sitä itsenäisesti ja helposti tarjota erilaisia Lightning-palveluita. Pystyt luomaan sillä salamaverkkolompakoita eikä niiden määrää ole rajoitettu. Jokaiselle lompakolle saat yksilölliset API-avaimet. Varojen osittaminen tekee siitä erittäin kätevän varojen hallinnassa sekä myös loistavan ohjelmistokehityksen alustatyökalun. Laajennukset lisäävät LNbits:in toiminnallisuuksia. Näinpä voit helposti testailla useita erilaisia ja viimeisimpiä salamaverkkoteknologioita. Laajennuksien kehittämisen olemme pyrkineet tekemään mahdollisimman helpoksi pitämällä LNbits:in ilmaisena OpenSource-projektina. Kannustamme kaikkia kehittämään ja jakelemaan omia laajennuksia!',
  ...
  date: 'Päiväys',
  path: 'Polku',
  internal_memo: 'Sisäinen kuvaus (valinnainen)',
  internal_memo_hint_receive:
    "Tämä sisäinen kuvaus ei näy maksajalle, vaan se talletetaan laskusi yhteyteen vain sinun nähtäväksi.",
  internal_memo_hint_pay:
    "Tämä sisäinen kuvaus ei näy maksun saajalle, vaan se talletetaan maksusi yhteyteen vain sinun nähtäväksesi.",
  ...
  preimage: 'Preimage',
  preimage_hint: 'Hold Invoice -laskun lunastamisen preimage',
  hold_invoice: 'Hold Invoice',
  hold_invoice_description:
    'Tämä lasku on pidossa ja sen lunastaminen vaatii preimage-tiedon.',
  payment_hash: 'Maksun tiiviste',
  invoice_cancelled: 'Lasku on peruutettu',
  invoice_settled: 'Lasku on lunastettu',
  hold_invoice_payment_hash: 'Hold Invoice:lle (valinnainen) Payment hash',
  settle_invoice: 'Lunasta lasku',
  cancel_invoice: 'Peruuta lasku',  
  fee: 'Kulu',
  amount: 'Määrä',
  amount_limits: 'Määrien rajat',
  amount_sats: 'Määrä (sat)',
  faucest_wallet: 'Faucet-lompakko',
  faucest_wallet_desc_1:
    'Aina kun toimittaja {provider} vahvistaa maksun, varat vähennetään tästä lompakosta.',
  faucest_wallet_desc_2:
    'Tämä auttaa seuraaamaan kaikkia {provider}:n maksuja ja niiden tilaa.',
  faucest_wallet_desc_3:
    'Tämän lompakon varoiksi täytyy asettaa satoshi-määrä, jonka omistaja hyväksyy vaihdettavaksi fiat-valuutaksi.',
  faucest_wallet_desc_4:
    'Mikäli varoja ei ole asetettu ja lompakko on konfiguroitu, {provider}:n maksuja ei käsitellä.',
  faucest_wallet_desc_5:
    'Vastaavasti tämän lompakon saldo voi mennä negatiiviseksi mikäli yhtäaikaisia valuutta maksuja tehdään.',
  faucest_wallet_id: 'Faucet-lompakon tunnus (valinnainen)',
  faucest_wallet_id_hint:
    'Faucet-lompakkon tunnus. Sitä käytetään varojen lähettämiseen käyttäjälle.',
  tag: 'Tunniste',
  unit: 'Yksikkö',
  description: 'Kuvaus',
  expiry: 'Vanhenee',
  ...
  webhook_url_hint:
    'Webhook URL mihin paksun tiedot lähetetään. sitä myös kutsutaan kun maksu on suoritettu.',
  webhook_events_list: 'Webhook:in tulee tukea seuraavia tapahtumatyyppejä:',
  ...
  ui_custom_badge_label: "Custom Badge 'USE WITH CAUTION'",
    "Yksilöity tunnus 'KÄYTÄ VAROVAISUUTTA'",
  ui_custom_badge_color_label: 'Yksilöidyn tunnuksen väri',
  themes: 'Teemat',
  ...
  secret_key: 'Secret-avain',
  signing_secret: 'Allekirjoitus secret',
  signing_secret_hint:
    'Secret jota webhook käyttää. Viestit allekirjoitetaan tätä secret:iä käyttäen.',
  callback_success_url: 'Callback Success URL',
  callback_success_url_hint:
    'Käyttäjä ohjataan tähän URL-osoitteeseen onnistuneen maksun jälkeen'
}
